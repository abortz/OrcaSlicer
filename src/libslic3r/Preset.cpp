...
static std::vector<std::string> s_Preset_print_options {
    ...
    "bridged_vase_mode", "bridged_vase_angle", "bridged_vase_grid_spacing_1", "bridged_vase_grid_angle_1", "bridged_vase_grid_spacing_2", "bridged_vase_grid_angle_2", "bridged_vase_interlocking_layers", "bridged_vase_first_offset",
    "slicing_mode",

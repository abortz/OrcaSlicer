...
PRINT_CONFIG_CLASS_DERIVED_DEFINE(
    ...
    // Bridged vase mode
    ((ConfigOptionBool,               bridged_vase_mode))
    ((ConfigOptionFloat,              bridged_vase_angle))
    ((ConfigOptionFloat,              bridged_vase_grid_spacing_1))
    ((ConfigOptionFloat,              bridged_vase_grid_angle_1))
    ((ConfigOptionFloat,              bridged_vase_grid_spacing_2))
    ((ConfigOptionFloat,              bridged_vase_grid_angle_2))
    ((ConfigOptionInt,                bridged_vase_interlocking_layers))
    ((ConfigOptionFloat,              bridged_vase_first_offset))
